...
if(username.length === 0) {
   document.getElementById("nameuser").innerHTML = "Vui lòng đặt tên!";  
} else {
  document.getElementById("nameuser").innerHTML = "Hi  " + username;
   document.getElementById("getnameuser").style.display = "none";
}
}
...
function question9() {
  currentQuestion = 9;
  document.getElementById("question").innerHTML = "Câu 9: Is she trying to gain weight?[Listening Question]";
